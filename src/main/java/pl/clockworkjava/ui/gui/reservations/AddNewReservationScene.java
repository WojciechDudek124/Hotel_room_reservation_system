...
public class AddNewReservationScene {
    ...
    public AddNewReservationScene(Stage modalStage, TableView<ReservationDTO> reservationTableView) {
        ...
        this.guestService.getGuestsAsDTO().forEach(dto->{
            guestSelectionItems.add(new GuestSelectionItem(
        ...
        Button addNewReservationButton = new Button("Dodaj nową rezerwacje");
        addNewReservationButton.setOnAction(actionEvent -> {
            ...
            try{
                this.reservationService.createNewReservation(from, to ,guestId, roomId);

                reservationTableView.getItems().clear();
                reservationTableView.getItems().addAll(this.reservationService.getReservationsAsDTO());
                modalStage.close();
        ...
        gridPane.add(addNewReservationButton,0,4);
