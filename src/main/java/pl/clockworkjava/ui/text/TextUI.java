...
public class TextUI {
    ...
    private void readNewGuestData(Scanner input) {
        ...
        try {
            ...
            System.out.println("Dodano nowego goscia: " + newGuest.getInfo());
    ...
    public void showMainMenu() {
        ...
        System.out.println("Trwa ladowanie danych...");
        ...
        try {
            ...
            System.out.println("Wystapil niespodziewany blad");
            System.out.println("Kod bledu nieznany");
            System.out.println("Komunikat bledu: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    private void performAction(Scanner input) {
        ...
        while (option != 0) {
            ...
            if (option == 1) {
                ...
                System.out.println("Wychodze z aplikacji. Zapisuje dane.");
                this.guestService.saveAll();
                this.roomService.saveAllRooms();
                this.reservationService.saveAllReservations();
            } else {
    ...
    private void createReservation(Scanner input) {
        ...
        try {
            ...
            if(res!=null) {
                System.out.println("Udalo sie stworzyc rezerwację");
            }
        } catch (IllegalArgumentException ex){
            System.out.println("Data zakonczenia rezerwacji nie moze byc wczesjniejsza niz rozpoczecia");
        }
    }
    ...
    private void editRoom(Scanner input) {
        ...
        try {
            ...
            throw new OnlyNumberException("Use numbers when edditing ID");
        }
    }

    private void removeRoom(Scanner input) {
        System.out.println("Podaj id pokoju do usuniecia");
        try {
            int id = input.nextInt();
            this.roomService.removeRoom(id);
        } catch (InputMismatchException e) {
            throw new OnlyNumberException("Use numbers when insterting ID");
        }
    }

    private void editGuest(Scanner input) {
        System.out.println("Podaj id goscia do edycji");
        ...
        try {
            ...
            throw new OnlyNumberException("Use numbers when edditing guest");
        }
    ...
    private void removeGuest(Scanner input) {
        System.out.println("Podaj id goscia do usuniecia");
        try {
            int id = input.nextInt();
    ...
    private static int getActionFromUser(Scanner in) {
        ...
        System.out.println("3. Wypisz wszystkich gosci.");
        ...
        System.out.println("9. Stwórz rezerwacje.");
